...
function nav(path) {
    ...
    <a href="https://peace.demonic.workers.dev" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'DemonicPeace Index'}">
