...
function nav(path) {
    ...
    <a href="https://potato.nanomancer.workers.dev/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Nanomancer Index'}">
