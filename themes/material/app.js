...
function nav(path) {
    ...
    <a href="https://lazy-index.nanomancer.workers.dev/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Mirror Senpai'}">
